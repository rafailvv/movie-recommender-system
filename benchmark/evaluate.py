...
model = RecommenderNet(num_zip_codes, num_release_years, num_occupations, num_genres, embedding_size)
...
Enter 1, 2 or 3: """))
    ...
    if menu == 2:
        ...
        user_id = int(input(f"Enter user_id (from 1 to {len(user_df['user_id'].tolist())}):"))
